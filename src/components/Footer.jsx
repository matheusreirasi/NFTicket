...
const Footer = () => {
    return (
        <div className="flex justify-around my-3">
            <div className="flex items-center text-xl rounded-xl hover:shadow-2xl hover:bg-fuchsia-200 hover:bg-opacity-20 hover:shadow-purple-600">
            ...
            <div className="flex items-center text-xl rounded-xl hover:shadow-2xl hover:bg-orange-200 hover:bg-opacity-20 hover:shadow-orange-300">
                <div className="white-glassmorphism p-3">
